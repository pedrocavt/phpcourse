...
$dateBirth = new DateTime("1995-10-11");
$dateStatic = DateTime::createFromFormat("d/m/Y", "10/11/1995");
...
$birth = new DateTime(date("Y") . "-11-10");
...
if($diff->invert){
    echo "seu aniversário foi a {$diff->days}";
}else{
    echo "Faltam {$diff->days} para seu aniversário";
}
